...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_split_3x6_3(KC_ESC, KC_QUOT, KC_COMM, KC_DOT, KC_P, KC_Y, KC_F, KC_G, KC_C, KC_R, KC_L, KC_SLSH, KC_SCLN, LGUI_T(KC_A), LALT_T(KC_O), LCTL_T(KC_E), LSFT_T(KC_U), KC_I, KC_D, LSFT_T(KC_H), LCTL_T(KC_T), LALT_T(KC_N), LGUI_T(KC_S), KC_MINS, KC_AT, KC_EXLM, RALT_T(KC_Q), KC_J, KC_K, KC_X, KC_B, KC_M, KC_W, RALT_T(KC_V), KC_Z, KC_DLR, KC_INS, LT(1,KC_SPC), LT(4,KC_TAB), KC_ENT, LT(2,KC_BSPC), KC_DEL),
